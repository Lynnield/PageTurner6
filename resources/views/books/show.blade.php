        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 bg-white border-b border-gray-200 flex flex-col md:flex-row gap-8">
                    <!-- Cover Image -->
                    <div class="w-full md:w-1/3 flex-shrink-0 flex items-center justify-center bg-indigo-50 rounded shadow-lg p-12 aspect-[2/3]">
                        <img src="{{ $book->cover_image_url }}" alt="{{ $book->title }}" class="object-contain w-full h-full opacity-80" onerror="this.src='https://placehold.co/400x600?text=No+Cover'">
                    </div>
